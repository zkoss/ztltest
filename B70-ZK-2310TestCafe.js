...
fixture`ZTL TEST - B70-ZK-2310TestCafe`
...
test("B70-ZK-2310TestCafe", async (t) => {
...
<portallayout maximizedMode="whole">
	...
	await t.click(Selector(() => jq("$p1").find(".z-panel-maximize")[0]));
	await ztl.waitResponse(t);
	await t.click(Selector(() => jq("$addPanel")[0]));
	await ztl.waitResponse(t);
	await t.expect(await ClientFunction(() => !!jq(".z-error")[0])()).notOk();
	await t.click(Selector(() => jq("$p1").find(".z-panel-maximized")[0]));
	await ztl.waitResponse(t);
	await t.click(Selector(() => jq("$p2").find(".z-panel-maximize")[0]));
	await ztl.waitResponse(t);
	await t.click(Selector(() => jq("$addPanel")[0]));
	await ztl.waitResponse(t);
	await t.expect(await ClientFunction(() => !!jq(".z-error")[0])()).notOk();
	await t.click(Selector(() => jq("$p2").find(".z-panel-maximized")[0]));
	await ztl.waitResponse(t);
	await t.click(Selector(() => jq("$p3").find(".z-panel-maximize")[0]));
	await ztl.waitResponse(t);
	await t.click(Selector(() => jq("$addPanel")[0]));
	await ztl.waitResponse(t);
	await t.expect(await ClientFunction(() => !!jq(".z-error")[0])()).notOk();
