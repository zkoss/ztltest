...
fixture`ZTL TEST - B50-3168509-1TestCafe`
...
test("B50-3168509-1TestCafe", async (t) => {
	...
	await t.click(Selector(() => zk.Widget.$(jq(".z-calendar")).$n("right")));
	await ztl.waitResponse(t);
	await t
		.wait(500)
		.click(
			Selector(
				() =>
					jq(
						".z-calendar-cell.z-calendar-weekday:contains(2):eq(0)",
					)[0],
			),
		);
	await ztl.waitResponse(t);
