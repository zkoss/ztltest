/* Z60_Grid_ListModelList_PagingTest.scala
...
{{IS_NOTE
	...
	History:
		Wed Jan 18 18:25:21 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
  * A test class for bug Grid-ListModelList-Paging
  *
  * @author benbai
  *
  */
@Tags(tags = "Z60-Grid-ListModelList-Paging.zul,Z60,A,E,Grid,ListModelList,Paging")
class Z60_Grid_ListModelList_PagingTest extends ZTL4ScalaTestCase {
