/* Z60_Selectbox_SimpleListModelTest.scala
...
{{IS_NOTE
	...
	History:
		Fri Jan 20 14:27:29 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Selectbox-SimpleListModel
 * @author benbai
 *
 */
@Tags(tags = "Z60-Selectbox-SimpleListModel.zul,Z60,A,E,Selectbox,SimpleListModel")
class Z60_Selectbox_SimpleListModelTest extends ZTL4ScalaTestCase {
