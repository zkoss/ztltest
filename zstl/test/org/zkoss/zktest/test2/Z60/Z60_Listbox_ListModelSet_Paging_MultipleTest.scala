/* Z60_Listbox_ListModelSet_Paging_MultipleTest.scala
...
{{IS_NOTE
	...
	History:
		Tue Jan 17 17:15:16 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
  * A test class for bug Listbox-ListModelSet-Paging-Multiple
  *
  * @author benbai
  *
  */
@Tags(tags = "Z60-Listbox-ListModelSet-Paging-Multiple.zul,Z60,A,E,Listbox,ListModelSet,Paging,Multiple")
class Z60_Listbox_ListModelSet_Paging_MultipleTest extends ZTL4ScalaTestCase {
