/* Z60_Grid_ListModelSet_noRODTest.scala
...
{{IS_NOTE
	...
	History:
		Thu Jan 19 09:29:15 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Grid-ListModelSet-noROD
 * @author benbai
 *
 */
@Tags(tags = "Z60-Grid-ListModelSet-noROD.zul,Z60,A,E,Grid,ListModelSet")
class Z60_Grid_ListModelSet_noRODTest extends ZTL4ScalaTestCase {
