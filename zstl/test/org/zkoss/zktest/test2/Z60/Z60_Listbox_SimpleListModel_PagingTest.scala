/* Z60_Listbox_SimpleListModel_PagingTest.scala
...
{{IS_NOTE
	...
	History:
		Mon Jan 16 14:23:55 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-SimpleListModel-Paging
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-SimpleListModel-Paging.zul,Z60,A,E,Listbox,Paging,SimpleListModel")
class Z60_Listbox_SimpleListModel_PagingTest extends ZTL4ScalaTestCase {
