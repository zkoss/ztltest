/* Z60_Grid_ListModelArray_noRODTest.scala
...
{{IS_NOTE
	...
	History:
		Wed Jan 18 17:10:27 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
  * A test class for bug Grid-ListModelArray-noROD
  *
  * @author benbai
  *
  */
@Tags(tags = "Z60-Grid-ListModelArray-noROD.zul,Z60,A,E,Grid,ListModelArray")
class Z60_Grid_ListModelArray_noRODTest extends ZTL4ScalaTestCase {
