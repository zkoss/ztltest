/* Z60_Combobox_ListModelMapTest.scala
...
{{IS_NOTE
	...
	History:
		Thu Jan 19 12:22:31 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Combobox-ListModelMap
 * @author benbai
 *
 */
@Tags(tags = "Z60-Combobox-ListModelMap.zul,Z60,A,E,Combobox,ListModelMap")
class Z60_Combobox_ListModelMapTest extends ZTL4ScalaTestCase {
