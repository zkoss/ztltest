/* Z60_Grid_ListModelSet_RODTest.scala
...
{{IS_NOTE
	...
	History:
		Thu Jan 19 09:29:23 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Grid-ListModelSet-ROD
 * @author benbai
 *
 */
@Tags(tags = "Z60-Grid-ListModelSet-ROD.zul,Z60,A,E,Grid,ListModelSet,ROD")
class Z60_Grid_ListModelSet_RODTest extends ZTL4ScalaTestCase {
