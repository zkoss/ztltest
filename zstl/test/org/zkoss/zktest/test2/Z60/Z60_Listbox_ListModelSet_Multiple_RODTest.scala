/* Z60_Listbox_ListModelSet_Multiple_RODTest.scala
...
{{IS_NOTE
	...
	History:
		Tue Jan 17 16:04:20 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-ListModelSet-Multiple-ROD
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-ListModelSet-Multiple-ROD.zul,Z60,A,E,Listbox,ListModelSet,Multiple,ROD")
class Z60_Listbox_ListModelSet_Multiple_RODTest extends ZTL4ScalaTestCase {
