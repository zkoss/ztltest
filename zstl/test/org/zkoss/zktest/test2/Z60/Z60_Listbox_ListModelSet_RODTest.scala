/* Z60_Listbox_ListModelSet_RODTest.scala
...
{{IS_NOTE
	...
	History:
		Tue Jan 17 16:51:27 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-ListModelSet-ROD
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-ListModelSet-ROD.zul,Z60,A,E,Listbox,ListModelSet,ROD")
class Z60_Listbox_ListModelSet_RODTest extends ZTL4ScalaTestCase {
