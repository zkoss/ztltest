/* Z60_Listbox_SimpleListModel_Multiple_RODTest.scala
...
{{IS_NOTE
	...
	History:
		Mon Jan 16 11:20:15 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-SimpleListModel-Multiple-ROD
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-SimpleListModel-Multiple-ROD.zul,Z60,A,E,Listbox,SimpleListModel,ROD")
class Z60_Listbox_SimpleListModel_Multiple_RODTest extends ZTL4ScalaTestCase {
