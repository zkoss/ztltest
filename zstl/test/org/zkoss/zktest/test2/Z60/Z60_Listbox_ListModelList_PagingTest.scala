/* Z60_Listbox_ListModelList_PagingTest.scala
...
{{IS_NOTE
	...
	History:
		Tue Jan 17 11:07:07 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-ListModelList-Paging
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-ListModelList-Paging.zul,Z60,A,E,Listbox,Paging,ListModelList")
class Z60_Listbox_ListModelList_PagingTest extends ZTL4ScalaTestCase {
