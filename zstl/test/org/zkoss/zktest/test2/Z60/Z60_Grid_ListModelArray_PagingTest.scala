/* Z60_Grid_ListModelArray_PagingTest.scala
...
{{IS_NOTE
	...
	History:
		Wed Jan 18 18:00:24 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
  * A test class for bug Grid-ListModelArray-Paging
  *
  * @author benbai
  *
  */
@Tags(tags = "Z60-Grid-ListModelArray-Paging.zul,Z60,A,E,Grid,ListModelArray,Paging")
class Z60_Grid_ListModelArray_PagingTest extends ZTL4ScalaTestCase {
