/* Z60_Radiogroup_ListModelMapTest.scala
...
{{IS_NOTE
	...
	History:
		Fri Jan 20 11:34:10 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Radiogroup-ListModelMap
 * @author benbai
 *
 */
@Tags(tags = "Z60-Radiogroup-ListModelMap.zul,")
class Z60_Radiogroup_ListModelMapTest extends ZTL4ScalaTestCase {
    ...
    val zscript = """
			<zk>
				<zscript>
					...
					ListModelMap model = ListModelMaps.getModel(ListModelMaps.DEFAULT,30);
					ListModelMap model2 = ListModelMaps.getModel(ListModelMaps.CLONEABLE,30);
