/* Z60_Listbox_SimpleListModel_Paging_MultipleTest.scala
...
{{IS_NOTE
	...
	History:
		Mon Jan 16 12:59:41 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-SimpleListModel-Paging-Multiple
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-SimpleListModel-Paging-Multiple.zul,Z60,A,E,Listbox,Paging,Multiple,SimpleListModel")
class Z60_Listbox_SimpleListModel_Paging_MultipleTest extends ZTL4ScalaTestCase {
    ...
    val zscript = """
			<zk>
				<zscript>
					...
					SimpleListModel model = SimpleListModels.getModel(SimpleListModels.MULTIPLE);
					SimpleListModel model2 = SimpleListModels.getModel(SimpleListModels.MULTIPLE_AND_CLONEABLE);
				...
				<div>
					...
					<div>5. Go to page 32, hold Ctrl then Select data 212 of third Listbox, data 213 of fourth and data 214 of fifth, the select status of last three listbox should not sync.</div>
