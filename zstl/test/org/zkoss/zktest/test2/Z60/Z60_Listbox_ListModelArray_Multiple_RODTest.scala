/* Z60_Listbox_ListModelArray_Multiple_RODTest.scala
...
{{IS_NOTE
	...
	History:
		Mon Jan 16 14:58:21 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-ListModelArray-Multiple-ROD
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-ListModelArray-Multiple-ROD.zul,Z60,A,E,Listbox,ListModelArray,Multiple,ROD")
class Z60_Listbox_ListModelArray_Multiple_RODTest extends ZTL4ScalaTestCase {
