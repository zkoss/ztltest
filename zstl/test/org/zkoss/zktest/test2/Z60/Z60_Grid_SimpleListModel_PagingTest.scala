/* Z60_Grid_SimpleListModel_PagingTest.scala
...
{{IS_NOTE
	...
	History:
		Thu Jan 19 11:03:05 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
  * A test class for bug Grid-SimpleListModel-Paging
  *
  * @author benbai
  *
  */
@Tags(tags = "Z60-Grid-SimpleListModel-Paging.zul,Z60,A,E,Grid,SimpleListModel,Paging")
class Z60_Grid_SimpleListModel_PagingTest extends ZTL4ScalaTestCase {
