/* Z60_Listbox_ListModelSet_PagingTest.scala
...
{{IS_NOTE
	...
	History:
		Tue Jan 17 17:26:05 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Listbox-ListModelSet-Paging
 * @author benbai
 *
 */
@Tags(tags = "Z60-Listbox-ListModelSet-Paging.zul,Z60,A,E,Listbox,ListModelSet,Paging")
class Z60_Listbox_ListModelSet_PagingTest extends ZTL4ScalaTestCase {
