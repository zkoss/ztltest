/* Z60_Grid_ListModelMap_PagingTest.scala
...
{{IS_NOTE
	...
	History:
		Thu Jan 19 09:29:01 CST 2012 , Created by benbai
}}IS_NOTE
...
/**
 * A test class for bug Grid-ListModelMap-Paging
 * @author benbai
 *
 */
@Tags(tags = "Z60-Grid-ListModelMap-Paging.zul,Z60,A,E,Grid,ListModelMap,Paging")
class Z60_Grid_ListModelMap_PagingTest extends ZTL4ScalaTestCase {
