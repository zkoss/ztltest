  ...
  def testClick() = {
    runZTL(
      () => {
        ...
        println("bl2h" + bl2h)
        println("bl3h" + bl3h)
        verifyEquals(bl2h, (bl1h / 2));
        verifyEquals(bl3h, (bl1h / 2));
