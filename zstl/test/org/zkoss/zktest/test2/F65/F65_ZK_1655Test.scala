  ...
  def testClick() = {
    ...
    runZTL(zscript,
      () => {
        ...
        println(cyan.offsetTop(), cyanPP.offsetTop())
        println(cyan.offsetLeft(), cyanPP.offsetLeft())
        ...
        verifyTolerant(cyanPP.offsetTop() - 20, pink.offsetTop() + 100, 1)
        verifyTolerant(cyanPP.offsetLeft(), pink.offsetLeft() + 100, 1)
