...
class B65_ZK_1433Test extends ZTL4ScalaTestCase {
  ...
  def testClick() = {
    val zscript = """<?component name="testwindow" macroURI="test2/B65-ZK-1433-1.zul" ?>
                  <zk>
    ...
    runZTL(zscript,
      () => {
        ...
        val window0Combobox0 = window0.find(".z-combobox-inp:eq(0)")
        val window0Combobox1 = window0.find(".z-combobox-inp:eq(1)")
        val window1Combobox0 = window1.find(".z-combobox-inp:eq(0)")
        val window1Combobox1 = window1.find(".z-combobox-inp:eq(1)")
        val window2Combobox0 = window2.find(".z-combobox-inp:eq(0)")
        val window2Combobox1 = window2.find(".z-combobox-inp:eq(1)")
        verifyTrue("window should be there", window2.exists())

        verifyEquals("combobox width in third window is equal to other window.", window2Combobox0.width(), window0Combobox0)
        verifyEquals("combobox width in third window is equal to other window.", window2Combobox0.width(), window1Combobox0)
        verifyEquals("combobox width in third window is equal to other window.", window2Combobox1.width(), window0Combobox1)
        verifyEquals("combobox width in third window is equal to other window.", window2Combobox1.width(), window1Combobox1)
      })
