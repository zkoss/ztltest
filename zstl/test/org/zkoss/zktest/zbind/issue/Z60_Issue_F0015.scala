 ...
 */
@Tags(tags = "zbind")
class Z60_Issue_F0015 extends ZTL4ScalaTestCase {
	def testIssue() = {
		val zul = {
...
//			Assert.assertEquals("",findWidget("$l23").getValue());
			...
			click(engine $f "btn1")
			verifyEquals("doCommand1",l11)
			verifyEquals("B",l12)
			verifyEquals("C",l13)
			verifyEquals("doCommand1",l21)
			verifyEquals("",l22)
			verifyEquals("",l23)
...
//			Assert.assertEquals("",findWidget("$l23").getValue());
			...
			click(engine $f "btn2")
			verifyEquals("doCommand1",l11)
			verifyEquals("doCommand2",l12)
			verifyEquals("doCommand3",l13)
			verifyEquals("doCommand1",l21)
			verifyEquals("doCommand2",l22)
			verifyEquals("doCommand3",l23)
