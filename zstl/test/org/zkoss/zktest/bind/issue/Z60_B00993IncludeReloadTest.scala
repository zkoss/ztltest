...
"""
    ...
    runZTL(zul, () => {
      ...
      var val1 = l1.toWidget().attr("value")
      var val2 = l2.toWidget().attr("value")
      click(reload.toWidget())
      waitResponse()
      l1 = jq("$l1")
      l2 = jq("$l2")
      verifyNotEquals(val1, l1.toWidget().attr("value"))
      verifyNotEquals(val2, l2.toWidget().attr("value"))

      val1 = l1.toWidget().attr("value")
      val2 = l2.toWidget().attr("value")
      click(reload.toWidget())
      waitResponse()
      l1 = jq("$l1")
      l2 = jq("$l2")
