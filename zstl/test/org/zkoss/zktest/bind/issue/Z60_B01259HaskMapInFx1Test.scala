...
"""
    runZTL(zul, () => {
      ...
      click(btn2.toWidget())
      waitResponse()
      verifyEquals("AAA", l11.toWidget().attr("value"))
      verifyEquals("AAA", l12.toWidget().attr("value"))
      verifyEquals("AAA", l13.toWidget().attr("value"))
      verifyEquals("BBB", l14.toWidget().attr("value"))
      verifyEquals("BBB", l15.toWidget().attr("value"))
      ...
      verifyEquals("AAA", l11.toWidget().attr("value"))
      verifyEquals("CCC", l12.toWidget().attr("value"))
      verifyEquals("AAA", l13.toWidget().attr("value"))
      verifyEquals("BBB", l14.toWidget().attr("value"))
      verifyEquals("DDD", l15.toWidget().attr("value"))

      click(btn3.toWidget())
      waitResponse()
      verifyEquals("CCC", l11.toWidget().attr("value"))
      verifyEquals("CCC", l12.toWidget().attr("value"))
      verifyEquals("CCC", l13.toWidget().attr("value"))
      verifyEquals("DDD", l14.toWidget().attr("value"))
      verifyEquals("DDD", l15.toWidget().attr("value"))
