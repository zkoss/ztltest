...
"""
    ...
    runZTL(zul, () => {
      ...
      verifyEquals("A", ls.eq(0).toWidget().attr("value"))
      ...
      verifyEquals(3, ls.length())
      verifyEquals("A", ls.eq(0).toWidget().attr("value"))
      verifyEquals("B", ls.eq(1).toWidget().attr("value"))
      verifyEquals("C", ls.eq(2).toWidget().attr("value"))
      ...
      ls = item2.find("@label")
      verifyEquals(1, ls.length())
      verifyEquals("D", ls.eq(0).toWidget().attr("value"))
      ...
      verifyEquals(3, ls.length())
      verifyEquals("D", ls.eq(0).toWidget().attr("value"))
      verifyEquals("E", ls.eq(1).toWidget().attr("value"))
      verifyEquals("F", ls.eq(2).toWidget().attr("value"))
