...
"""
    ...
    runZTL(zul, () => {
      ...
      verifyEquals("A", l11.attr("value"))
      verifyEquals("B", l12.attr("value"))
      verifyEquals("C", l13.attr("value"))
      verifyEquals("D", l14.attr("value"))
      t11.toElement().set("value", "")
      sendKeys(t11, "Q" + Keys.TAB)
      waitResponse()
      verifyEquals("Q", l11.attr("value"))
      verifyEquals("B", l12.attr("value"))
      verifyEquals("C", l13.attr("value"))
      verifyEquals("D", l14.attr("value"))
      ...
      waitResponse()
      verifyEquals("Q", l11.attr("value"))
      verifyEquals("W", l12.attr("value"))
      verifyEquals("E", l13.attr("value"))
      verifyEquals("D", l14.attr("value"))
      ...
      verifyEquals("W", l12.attr("value"))
      verifyEquals("E", l13.attr("value"))
      verifyEquals("command 1", l14.attr("value"))
      verifyEquals("command 1", t14.attr("value"))
    })
  }
}
