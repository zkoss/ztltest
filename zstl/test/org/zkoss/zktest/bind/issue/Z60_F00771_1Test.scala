...
"""
    ...
    runZTL(zul, () => {
      ...
      verifyEquals("value2 must equalsIgnoreCase to def - by key", l12.toWidget().get("value"))
      verifyEquals("value2 must equalsIgnoreCase to def", l21.toWidget().get("value"))
      verifyEquals("value2 must equalsIgnoreCase to def - by key", l22.toWidget().get("value"))
      verifyEquals("value3 must equalsIgnoreCase to xyz", l31.toWidget().get("value"))
      verifyEquals("value3 must equalsIgnoreCase to xyz - by key", l32.toWidget().get("value"))
      ...
      verifyEquals("", val3.toWidget().get("value"))
      verifyEquals("", l11.toWidget().get("value"))
      verifyEquals("value3 must equalsIgnoreCase to xyz - by key", l12.toWidget().get("value"))
      verifyEquals("", l21.toWidget().get("value"))
      verifyEquals("value3 must equalsIgnoreCase to xyz - by key", l22.toWidget().get("value"))
      verifyEquals("value3 must equalsIgnoreCase to xyz", l31.toWidget().get("value"))
      verifyEquals("value3 must equalsIgnoreCase to xyz - by key", l32.toWidget().get("value"))
      ...
      waitResponse()
      verifyEquals("abc", t11.toWidget().get("value"))
      verifyEquals("de", t21.toWidget().get("value"))
      verifyEquals("xy", t31.toWidget().get("value"))
      verifyEquals("", l11.toWidget().get("value"))
      verifyEquals("value2 must equalsIgnoreCase to def - by key", l12.toWidget().get("value"))
      verifyEquals("value2 must equalsIgnoreCase to def", l21.toWidget().get("value"))
      verifyEquals("value2 must equalsIgnoreCase to def - by key", l22.toWidget().get("value"))
      ...
      waitResponse()
      verifyEquals("abc", t11.toWidget().get("value"))
      verifyEquals("def", t21.toWidget().get("value"))
      verifyEquals("xy", t31.toWidget().get("value"))
      verifyEquals("", l11.toWidget().get("value"))
      verifyEquals("value3 must equalsIgnoreCase to xyz - by key", l12.toWidget().get("value"))
      verifyEquals("", l21.toWidget().get("value"))
