...
"""
    ...
    runZTL(zul, () => {
      ...
      //validate property before command
      verifyEquals("", getValue(tb41))
      verifyEquals("", getValue(tb42))
      verifyEquals("", getText(lb41))
      verifyEquals("", getText(lb42))
      ...
      click(btn2)
      waitResponse()
      verifyEquals("value3 is empty", getText(lb42))
      ...
      waitResponse()
      verifyEquals("", getText(lb41))
      verifyEquals("value4 is empty", getText(lb42))
      //		findWidget("$tb41").keys("abc").tab();
      //		findWidget("$btn2").click();
      //		Assert.assertEquals("",findWidget("$lb41").getValue());
      ...
      waitResponse()
      verifyEquals("", getText(lb41))
      verifyEquals("value4 must euqlas to value 3", getText(lb42))
      //		findWidget("$btn2").click();
      //		Assert.assertEquals("",findWidget("$lb41").getValue());
      ...
      click(btn2)
      waitResponse()
      verifyEquals("abc", getText(lb41))
      verifyEquals("do Command2", getText(lb42))
      //		findWidget("$btn2").click();
