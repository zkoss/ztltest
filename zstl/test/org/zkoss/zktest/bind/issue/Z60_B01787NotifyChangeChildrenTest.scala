/* Z60_B01787NotifyChangeChildrenTest.scala
...
"""
    ...
    val answer = Array(
      Array("Item A:1", "Item B:1", "Item A:1", "Item B:1"),
      Array("Item A:2", "Item B:2", "Item A:2", "Item B:2"),
      Array("Item A.*:x:0", "Item B:2", "Item A.*:0", "Item B:1"),
      Array("Item A.name:0", "Item B:1", "Item A.name:0", "Item B:1"),
      Array("Item A:2", "Item B.*:x:0", "Item A:1", "Item B.*:0"),
      Array("Item A:1", "Item B.name:0", "Item A:1", "Item B.name:0"))
