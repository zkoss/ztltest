...
"""
    ...
    runZTL(zul, () => {
      ...
      verifyEquals("-1", sb1.attr("selectedIndex"))
      verifyEquals("-1", sb2.attr("selectedIndex"))
      verifyEquals("1", sb3.attr("selectedIndex"))
      select(jq(sb1), 0)
      waitResponse()
      select(jq(sb2), 1)
      waitResponse()
      select(jq(sb3), 2)
      waitResponse()
      verifyEquals("0", sb1.attr("selectedIndex"))
      verifyEquals("1", sb2.attr("selectedIndex"))
      verifyEquals("2", sb3.attr("selectedIndex"))
      click(btn1)
      waitResponse()
      verifyEquals("0", sb1.attr("selectedIndex"))
      verifyEquals("1", sb2.attr("selectedIndex"))
      ...
      verifyEquals("0", sb1.attr("selectedIndex"))
      verifyEquals("1", sb2.attr("selectedIndex"))
      verifyEquals("3", sb3.attr("selectedIndex"))
    })
  }
}
