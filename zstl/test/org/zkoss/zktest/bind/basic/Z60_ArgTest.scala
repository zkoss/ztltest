...
class Z60_ArgTest extends ZTL4ScalaTestCase {
  ...
  def testArg() = {
    ...
    runZTL(zul, () => {
      ...
      verifyEquals("A-Arg1", getText(l1));
      verifyEquals("B-myarg1", getText(l2));
      ...
      waitResponse()
      verifyEquals("X-Arg2-Arg1", getText(l1));
      verifyEquals("B-myarg1", getText(l2));
      ...
      waitResponse()
      verifyEquals("X-Arg2-Arg1", getText(l1));
      verifyEquals("Y-myarg2-myarg1", getText(l2));
      verifyEquals("X-Arg2-Arg1", getValue(t1));
      verifyEquals("Y-myarg2-myarg1", getValue(t2));

      click(engine.$f("btn1"))
      waitResponse()
      verifyEquals("X-Arg2Dennis-Arg1", getText(l1));
      verifyEquals("Y-myarg2Chen-myarg1", getText(l2));
      ...
      waitResponse()
      verifyEquals("value have to equals V1", getText(l3));

      `type`(t3, "V1")
      sendKeys(t3, Keys.TAB)
      waitResponse()
      verifyEquals("", getText(l3));
      verifyEquals("V1-Arg1", getText(l1));
      ...
      waitResponse()
      verifyEquals("", getText(l4));
      click(engine.$f("btn2"))
      waitResponse()
      verifyEquals("value have to equals V2", getText(l4));
      ...
      click(engine.$f("btn2"))
      waitResponse()
      verifyEquals("execute cmd2", getText(l4));
      verifyEquals("V2-Arg1", getText(l1));
