...
class IVT_Chosenbox_Base_Test extends ZTL4ScalaTestCase {
	def testClick() = {
		val zscript = """
<zk>
	<zscript>
	<![CDATA[
		...
		ListModel model = new ListModelList(new String[] { 
				...
				"Codlin", "Core", "Cranberry", "Cumquat", "Damson", "Date", "Dew", "Durian",
		        "Casaba", "Cascara", "Cherry", "Chestnut", "Coconut", "Codlin",
		        "Core", "Cranberry", "Cumquat", "Damson", "Date", "Dew", "Durian",
		        "Fig", "Filbert", "Flat", "Foxnut", "Ginkgo", "Gooseberry",
