...
fixture`ZTL TEST - F60-ZK-701-ListboxTestCafe`
...
test("F60-ZK-701-ListboxTestCafe", async (t) => {
	...
	await t.click(
		Selector(() =>
			zk.Widget.$(jq(".z-listgroup:contains(Seafood)")).$n("img"),
		),
	);
	...
	await t
		...
		.ok("Seafood group of cloned grid should be opened");
});
