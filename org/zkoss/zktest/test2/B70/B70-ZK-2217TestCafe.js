...
fixture`ZTL TEST - B70-ZK-2217TestCafe`
...
test("B70-ZK-2217TestCafe", async (t) => {
...
<zk xmlns="http://www.zkoss.org/2005/zul" xmlns:n="native">
	...
	let verifyVariable_cafe_0_0 = await ClientFunction(() =>
		jq(zk.Widget.$(jq(".z-listbox")).$n("foot")).is(":visible"),
	)();
	let verifyVariable_cafe_1_1 = await ClientFunction(() =>
		jq(zk.Widget.$(jq(".z-listbox")).$n("pgib")).is(":visible"),
	)();
	await t
		.expect(verifyVariable_cafe_0_0 && verifyVariable_cafe_1_1)
		.ok("the footer and paging should not hide");
});
