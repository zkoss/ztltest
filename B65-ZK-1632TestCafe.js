...
fixture`ZTL TEST - B65-ZK-1632TestCafe`
...
test("B65-ZK-1632TestCafe", async (t) => {
...
<zk xmlns="http://www.zkoss.org/2005/zul"
	...
	await ClientFunction(() => {
		jq(".z-center")[0].style.top = 3000;
	})();
	await t.wait(3000);
	await ClientFunction(() => {
		zk.Widget.$(jq(".z-center")).$n("cave").firstChild.style.top = 0;
	})();
	await t.expect("false").ok("errorbox should disappear. ");
});
